...
class Triplefunhistory extends StatefulWidget {
  const Triplefunhistory({Key? key}) : super(key: key);
  @override
  State<Triplefunhistory> createState() => _homeState();
}
class _homeState extends State<Triplefunhistory> {
  ...
  Future<List<Alb>> bowe() async{
    ...
    final response = await http.get(
      Uri.parse(Apiconstant.baseurl+'bet_history?user_id=$value&gameid=7'),
    );
