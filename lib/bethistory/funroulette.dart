...
class Funroulette extends StatefulWidget {
  const Funroulette({Key? key}) : super(key: key);
  @override
  State<Funroulette> createState() => _homeState();
}
class _homeState extends State<Funroulette> {
  ...
  Future<List<Alb>> bowe() async{
    ...
    final response = await http.get(
      Uri.parse(Apiconstant.baseurl+'bet_history?user_id=$value&gameid=6'),
    );
