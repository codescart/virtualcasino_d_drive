...
import 'package:virtualcasino/clock/clock_dial_painter.dart';
import 'package:virtualcasino/clock/clock_hands.dart';
...
class ClockFace extends StatelessWidget{
  ...
  ClockFace({this.clockText = ClockText.arabic, this.showHourHandleHeartShape = false, required this.dateTime});
