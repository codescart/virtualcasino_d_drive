...
class WelcomeAndar extends StatefulWidget {
  const WelcomeAndar({Key? key}) : super(key: key);


  @override
  State<WelcomeAndar> createState() => _WelcomeAndarState();
}


class _WelcomeAndarState extends State<WelcomeAndar> {
  double percent = 0.0;
  ...
  sound() async{
    await _player.play('audio/dragontiger.mp3');
  }
  @override
