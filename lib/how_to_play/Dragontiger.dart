...
class DragonTiger extends StatefulWidget {
  const DragonTiger({Key? key}) : super(key: key);
  @override
  State<DragonTiger> createState() => _homeState();
}
class _homeState extends State<DragonTiger> {
  ...
  Future<List<Alb>> bowe() async{
    ...
    final response = await http.get(
      Uri.parse(Apiconstant.baseurl+'howtoplay?game_id=5'),
    );
