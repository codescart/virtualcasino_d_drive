...
class Andarbhar extends StatefulWidget {
  const Andarbhar({Key? key}) : super(key: key);
  @override
  State<Andarbhar> createState() => _homeState();
}
class _homeState extends State<Andarbhar> {
  ...
  Future<List<Alb>> bowe() async{
    ...
    final response = await http.get(
      Uri.parse(Apiconstant.baseurl+'howtoplay?game_id=4'),
    );
