...
class triplefuntarget extends StatefulWidget {
  const triplefuntarget({Key? key}) : super(key: key);
  @override
  State<triplefuntarget> createState() => _homeState();
}
class _homeState extends State<triplefuntarget> {
  ...
  Future<List<Alb>> bowe() async{
    ...
    final response = await http.get(
      Uri.parse(Apiconstant.baseurl+'howtoplay?game_id=7'),
    );
