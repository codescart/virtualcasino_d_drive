...
class welcomeFuncasino extends StatefulWidget {
  const welcomeFuncasino({Key? key}) : super(key: key);


  @override
  State<welcomeFuncasino> createState() => _welcomeFunState();
}


class _welcomeFunState extends State<welcomeFuncasino> {
  double percent = 0.0;
